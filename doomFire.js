...
function chooseFireMode(value){
  wichRenderization = value
}
...
function calculateFirePropagation(){
   ...
   switch(wichRenderization){
    case 0: renderFire(); break; 
    case 1: renderBlueFire(); break;
   }
...
function updateFireIntensityPerPixel(currentPixelIndex){
  ...
  // if overflows canva's limits, do nothing
